...
<head>
    ...
    <title>BAT Registration Confirmation</title>
...
<body>
   <div class="regform">
        <form action="conreq.php" method="post">
            ...
            <input type="text" name="assigned_barangay" value="<?php echo htmlspecialchars($_SESSION['assigned_barangay']); ?>" readonly>
            <br><br>
...
<?php
    if (isset($_POST["proceed"])){
        ...
        $data = [
            ...
            'assigned_barangay' => $_SESSION['assigned_barangay'],
        ...
        // Register bat in database
        $result = $batRegistrationHandler->registerBAT($data);
